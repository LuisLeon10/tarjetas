...
let mesas = function(){
    ...
    for(i=0; i<nm; i++){
        ...
        'Adultos <select id="adultos'+i+'" name="adultos'+i+'" class="form-control" onchange="functionMenores'+i+'()">'+
...
let functionMenores0 = function(){
    ...
    let contenido="";
    if(numA==1){
        contenido+='Menores <select id="menores0" name="menores0" class="form-control" onchange="obtMenores0()">'+
        '<option value="0">Seleccione...</option>'+
        ...
        contenido+='Menores <select id="menores0" name="menores0" class="form-control">'+
...
let functionMenores1 = function(){
    ...
    let contenido="";
    if(numA==1){
        contenido+='Menores <select id="menores1" name="menores1" class="form-control" onchange="obtMenores1()">'+
        '<option value="0">Seleccione...</option>'+
        '<option value="1">1 Menor</option>'+
        '<option value="2">2 Menores</option>'+
        '<option value="3">3 Menores</option>'+
        ...
        contenido+='Menores <select id="menores1" name="menores1" class="form-control">'+
        '<option value="0">Ya no se pueden menores</option>'+
        '</select><br><br>';
    }
...
let functionMenores2 = function(){
    ...
    let contenido="";
    if(numA==1){
        contenido+='Menores <select id="menores2" name="menores2" class="form-control" onchange="obtMenores2()">'+
        '<option value="0">Seleccione...</option>'+
        '<option value="1">1 Menor</option>'+
        '<option value="2">2 Menores</option>'+
        '<option value="3">3 Menores</option>'+
        ...
        contenido+='Menores <select id="menores2" name="menores2" class="form-control">'+
        '<option value="0">Ya no se pueden menores</option>'+
        '</select><br><br>';
    }
...
let functionMenores3 = function(){
    ...
    let contenido="";
    if(numA==1){
        contenido+='Menores <select id="menores3" name="menores3" class="form-control" onchange="obtMenores3()">'+
        '<option value="0">Seleccione...</option>'+
        '<option value="1">1 Menor</option>'+
        '<option value="2">2 Menores</option>'+
        '<option value="3">3 Menores</option>'+
        ...
        contenido+='Menores <select id="menores3" name="menores3" class="form-control">'+
        '<option value="0">Ya no se pueden menores</option>'+
        '</select><br><br>';
    }
...
let functionMenores4 = function(){
    ...
    let contenido="";
    if(numA==1){
        contenido+='Menores <select id="menores4" name="menores4" class="form-control" onchange="obtMenores4()">'+
        '<option value="0">Seleccione...</option>'+
        '<option value="1">1 Menor</option>'+
        '<option value="2">2 Menores</option>'+
        '<option value="3">3 Menores</option>'+
